  ...
  return (
    <nav className="bg-transparent text-white py-4  w-full z-50">
      ...
      <div className="flex items-center justify-between container m-auto ">
        {isDarkMode ? (<svg width="47" height="61" className="w-12 h-16 md:w-14 md:h-18 " viewBox="0 0 47 61" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        </svg>) : (<svg width="47" height="61" className="w-12 h-16 md:w-14 md:h-18 "  viewBox="0 0 47 61" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex gap-[10px]">
          ...
          <div className='rounded-full overflow-hidden'>   <button
