...
const Services = () => {
  return (
    ...
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
      {/* First Row - 3 Columns */}
      <div className="bg-darkBlue rounded-lg hover:shadow-customlight hover:shadow-customdark p-8 text-center transform transition-transform hover:-translate-y-10 border-[1px] border-pink-500 dark:border-white border-opacity-50">
      ...
      <div className="md:col-span-1 md:col-start-2 bg-darkBlue rounded-lg hover:shadow-customlight hover:shadow-customdark p-8 text-center transform transition-transform hover:-translate-y-10 border-[1px] border-pink-500 dark:border-white border-opacity-50">
      <div className='bg-gray-500 bg-opacity-50 w-[110px] h-[110px] mx-auto rounded-full flex justify-center items-center mb-[20px]'> 
      ...
      <div className="md:col-span-1 bg-darkBlue rounded-lg hover:shadow-customlight hover:shadow-customdark p-8 text-center transform transition-transform hover:-translate-y-10 border-[1px] border-pink-500 dark:border-white border-opacity-50">
      <div className='bg-gray-500 bg-opacity-50 w-[110px] h-[110px] mx-auto rounded-full flex justify-center items-center mb-[20px]'> 
